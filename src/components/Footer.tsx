    ...
    <footer className="bg-[#0F172A] text-slate-400 pt-16 pb-8">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-16 border-b border-slate-800 mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            <input 
              type="email" 
              placeholder="Enter your email" 
              className="w-full bg-slate-800 border-none rounded-full py-4 px-6 text-white focus:ring-2 focus:ring-[#EBCB00] outline-none transition"
            />
            <button className="bg-[#EBCB00] hover:bg-[#d4b800] text-black font-bold py-4 px-8 rounded-full transition-all flex items-center gap-2 whitespace-nowrap active:scale-95 shadow-lg shadow-yellow-900/20">
              Subscribe <ArrowRight size={18} />
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#EBCB00] rounded-lg flex items-center justify-center text-black font-bold text-xl">P</div>
              <h2 className="text-white text-2xl font-bold tracking-tight">Prajwalika AP</h2>
            </div>
            <p className="text-sm leading-relaxed">
              Fostering community through annual get-togethers and welfare programs, 
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-[#EBCB00] hover:text-black transition-all duration-300">
                <Globe size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-[#EBCB00] hover:text-black transition-all duration-300">
                <Users size={20} />
          ...
          <div>
            <h3 className="text-white font-bold mb-6 text-lg uppercase tracking-wider">Foundation</h3>
            <ul className="space-y-4 text-sm font-medium">
              <li><Link to="/" className="hover:text-[#EBCB00] transition-colors">Home</Link></li>
              <li><Link to="/about" className="hover:text-[#EBCB00] transition-colors">Our Story</Link></li>
              <li><Link to="/mission" className="hover:text-[#EBCB00] transition-colors">Mission & Vision</Link></li>
              <li><Link to="/donate" className="text-[#EBCB00] hover:brightness-110 transition-all font-bold">Donate Now</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-white font-bold mb-6 text-lg uppercase tracking-wider">Resources</h3>
            <ul className="space-y-4 text-sm font-medium">
              <li><Link to="/contact" className="hover:text-[#EBCB00] transition-colors">Contact Us</Link></li>
              <li><Link to="/login" className="hover:text-[#EBCB00] transition-colors">Member Portal</Link></li>
              <li><a href="#" className="hover:text-[#EBCB00] transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-[#EBCB00] transition-colors">Terms of Service</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="text-[#EBCB00] shrink-0" size={20} />
                <span>123 Welfare Street, Education Hub,<br/>City, State, Pin - 500001</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-[#EBCB00] shrink-0" size={20} />
                <a href="mailto:info@prajwalika.org" className="hover:text-[#EBCB00] transition">info@prajwalika.org</a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="text-[#EBCB00] shrink-0" size={20} />
                <span>+91 98765 43210</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-right order-1 md:order-2">
            ...
            <span className="text-[10px] uppercase tracking-widest text-[#EBCB00] font-bold mt-1 block">— Dr. A.P.J. Abdul Kalam</span>
          </div>
        </div>
      </div>
    </footer>
